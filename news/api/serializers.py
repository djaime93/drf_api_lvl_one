...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    def validate_title(self, value):
        ...
        if len(value) < 30:
            raise serializers.ValidationError("The title has to be atleast 30 chars long")
        return value
...
#     def validate_title(self, value):
#         if len(value) < 60:
#             raise serializers.ValidationError("The title has to be atleast 60 chars long")
#         return value